                                      ...
                                      <?php
                                        if(isset($produtos)){
                                          foreach ($produtos as $f) { ?>
                                            <tr class="odd gradeX">
                                                <td><a href="index.php?secao=Produto&acao=buscarProdutoPorId&id=<?php echo $f->getId() ?>"><?php echo $f->getNome() ?></a></td>
                                                <td><a href="index.php?secao=Produto&acao=excluirProduto&id=<?php echo $f->getId() ?>">Excluir Produto</a>
                                                | <a href="index.php?secao=Produto&acao=buscarProdutoPorIdParaAtualizar&id=<?php echo $f->getId() ?>">Atualizar Produto</a></td>
                                            </tr>
                                          <?php }
                                        } ?>
