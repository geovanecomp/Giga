                                      ...
                                      <?php
                                        if(isset($fornecedores)){
                                          foreach ($fornecedores as $f) { ?>
                                            <tr class="odd gradeX">
                                                <td><a href="index.php?secao=Fornecedor&acao=buscarFornecedorPorId&id=<?php echo $f->getId() ?>"><?php echo $f->getNome() ?></a></td>
                                                <td><a href="index.php?secao=Fornecedor&acao=excluirFornecedor&id=<?php echo $f->getId() ?>">Excluir Fornecedor</a>
                                                | <a href="index.php?secao=Fornecedor&acao=buscarFornecedorPorIdParaAtualizar&id=<?php echo $f->getId() ?>">Atualizar Fornecedor</a></td>
                                            </tr>
                                          <?php }
                                        } ?>
